...
--
-- Name: holdings Admins can delete any holdings; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Admins can delete any holdings" ON public.holdings FOR DELETE USING (public.has_role(auth.uid(), 'admin'::public.app_role));


--
-- Name: holdings Admins can insert any holdings; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Admins can insert any holdings" ON public.holdings FOR INSERT WITH CHECK (public.has_role(auth.uid(), 'admin'::public.app_role));
...
--
-- Name: holdings Admins can update any holdings; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Admins can update any holdings" ON public.holdings FOR UPDATE USING (public.has_role(auth.uid(), 'admin'::public.app_role));


--
-- Name: holdings Admins can view all holdings; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Admins can view all holdings" ON public.holdings FOR SELECT USING (public.has_role(auth.uid(), 'admin'::public.app_role));
